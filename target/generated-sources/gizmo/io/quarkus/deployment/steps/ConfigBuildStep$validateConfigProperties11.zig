// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties11
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties11#deploy_0
    RETURN
    ** label2
