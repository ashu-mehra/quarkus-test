// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent15
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent15#deploy_0
    RETURN
    ** label2
