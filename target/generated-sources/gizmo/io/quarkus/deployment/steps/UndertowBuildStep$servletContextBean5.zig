// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean5
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean5#deploy_0
    RETURN
    ** label2
