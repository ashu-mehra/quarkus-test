// Class: io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection12
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection12#deploy_0
    RETURN
    ** label2
