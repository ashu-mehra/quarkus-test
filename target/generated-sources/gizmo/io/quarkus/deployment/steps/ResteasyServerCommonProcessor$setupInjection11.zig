// Class: io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection11
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection11#deploy_0
    RETURN
    ** label2
